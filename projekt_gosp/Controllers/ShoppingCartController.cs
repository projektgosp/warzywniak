...
namespace projekt_gosp.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public int AddCart(int ItemId, int Quantity)
        {
            ...
            additionalModels.CartModel objcart = new additionalModels.CartModel()
            {
                UserName = username,
                ID_produktu = ItemId,
                Ilosc = Quantity
        ...
        public PartialViewResult DeleteCart(int itemId)
        {
            ...
            additionalModels.CartModel removeCart = Cartcontext.Koszyk.FirstOrDefault(s => s.UserName == getName && s.ID_produktu == itemId);
